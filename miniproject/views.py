...
def sim(request):
    ...
    hint = obj1.hints()
    return render(request, 'sim1.html', {'title': "Simulation", 'ip': x, 'ipx': ipx, 'class': classs, 'subnet': subnet, 'host': host, 'mask': mask, 'compare': compare,'classhint':hint[0], 'subnethint':hint[1],'hosthint': hint[2]})
